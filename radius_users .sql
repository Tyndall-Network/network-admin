...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2020 at 12:46 AM
...
CREATE TABLE `MPesa` (
  ...
  `resultCode` int(30) NOT NULL,
  `resultDesc` varchar(100) NOT NULL,
  `amount` int(45) NOT NULL,
  `mpesaReceiptNumber` varchar(45) NOT NULL,
...
INSERT INTO `MPesa` (`id`, `merchantRequestID`, `checkoutRequestID`, `resultCode`, `resultDesc`, `amount`, `mpesaReceiptNumber`, `balance`, `TransactionDate`, `phoneNumber`, `TimeStamp`) VALUES
(1, '16462-7027310-1 ', 'ws_CO_031220201439227484 ', 0, 'The service request is processed successfully.', 1, 'OL375ONVOZ', NULL, '20201203143929', '254727596412', '2020-12-04 22:34:29');

-- --------------------------------------------------------

--
-- Table structure for table `mpesaFailed`
--

CREATE TABLE `mpesaFailed` (
  `id` int(11) NOT NULL,
  `merchantRequestID` varchar(30) DEFAULT NULL,
  `checkoutRequestID` varchar(30) NOT NULL,
  `resultCode` int(30) DEFAULT NULL,
...
(1, '10.0.0.1', 'MikroTik', 'other', 0, 'Tyndall1!', '', '', '');
...
(6, 'administrator', 'radius', '', '', '', '', '', '', '', '', '', '', '', '', '2020-11-25 10:49:09', '2009-12-07 20:12:33', 'admin', '2020-11-25 11:04:42', 'administrator');
...
(1, 'Test_User', 'Cleartext-Password', ':=', '4321'),
(2, 'Test_User', 'Expiration', ':=', '25 Nov 2020'),
(3, 'Test_User', 'Simultaneous-Use', ':=', '2');
...
(1, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:32:10'),
(2, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:32:24'),
(3, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:32:34'),
(4, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:32:52'),
(5, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:33:17'),
(6, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:33:26'),
(7, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:37:15'),
(8, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:37:26'),
(9, 'Admin', '1234', 'Access-Reject', '2020-11-25 07:37:55');
...
(1, 'Test_User', NULL, NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', NULL, NULL, NULL, NULL, NULL, NULL, '2020-11-25 11:12:51', 'administrator', NULL, NULL);
...
(1, 'Test_User', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', '', 0, '2020-11-25 11:12:51', 'administrator', NULL, NULL);
...
--
-- Indexes for table `mpesaFailed`
--
ALTER TABLE `mpesaFailed`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `mpesaFailed`
--
ALTER TABLE `mpesaFailed`
